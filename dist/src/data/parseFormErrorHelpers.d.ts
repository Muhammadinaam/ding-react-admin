 ...
 */
export declare function parseDjangoDRFFormErrors(error: unknown, ctx: ParseFormErrorContext): FormValidationErrors | null;
 ...
 */
export declare function parseDotNetFormErrors(error: unknown, ctx: ParseFormErrorContext, options?: DotNetFormErrorOptions): FormValidationErrors | null;
 ...
 */
export declare function parseNodeFormErrors(error: unknown, ctx: ParseFormErrorContext, options?: NodeFormErrorOptions): FormValidationErrors | null;

...
export declare function FormTabs({ children, defaultActiveKey, activeKey: controlledActiveKey, onChange, ...tabsProps }: FormTabsProps): import("react/jsx-runtime").JSX.Element;

...
export declare function applyApiErrorsToForm<T extends FieldValues>(dp: DataProvider, form: UseFormReturn<T>, message: MessageInstance, error: unknown, context: ParseFormErrorContext): boolean;

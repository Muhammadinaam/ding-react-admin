...
export declare function ReferenceFilter({ source, label, reference, choices, optionLabel, optionValue, multiple, search, lazy, fetchSelected, popupMatchSelectWidth, popupMinWidth, }: ReferenceFilterProps): null;
